...
@section('content')
    ...
    <div class="container">
        <div class="row mt-5">
            <h1 class='mt-5 text-center'>Aggiungi una Tecnologia</h1>
            <div class="col-12 col-sm-7 mt-3">
                ...
                <form action="{{ route('admin.technologies.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 mt-5 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Inserisci qui la Tecnologia" value="{{ old('name') }}" required>
                        </div>
                    </div>
