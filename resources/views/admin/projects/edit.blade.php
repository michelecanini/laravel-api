            ...
            <div class="col-12 col-sm-6 mt-3">
                ...
                <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description" name="description" placeholder="Inserisci qui la Descrizione">{{ old('description') ?? $project->description }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3 form-group">
                        <div>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="github" name="github" placeholder="Esempio: https://static.dc.com/dc/... " value="{{ old('github') ?? $project->github }}"> {{-- no required in caso di progetti privati --}}
                        </div>
                    </div>
                    <div class="row mb-3 form-group">
                        <label class="col-sm-2 col-form-label control-label">Demo</label>
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="demo" name="demo" placeholder="Esempio: https://static.dc.com/dc/... " value="{{ old('demo') ?? $project->demo }}">
                        </div>
                    </div>
